  ...
  it('emits sectioned sample lathecodes without hiding the start section', () => {
    ...
    expect(Array.from(sampleCards).map(card => card.querySelector('strong')?.textContent)).toEqual(
      expect.arrayContaining([
        ...
        'Calibration Rod Set',
        'Desk Totem Kit',
        'MT1-MT2 Adapter Sleeve',
        'MT1-MT3 Adapter Sleeve',
        'MT1-MT4 Adapter Sleeve',
        'MT2-MT3 Adapter Sleeve',
        'MT2-MT4 Adapter Sleeve',
        'MT2-MT5 Adapter Sleeve',
        'MT3-MT4 Adapter Sleeve',
        'MT3-MT5 Adapter Sleeve',
        'MT4-MT5 Adapter Sleeve',
        'MT1 to MT1 Extension',
        'MT1 to MT2 Extension',
        'MT2 to MT1 Extension',
        'MT2 to MT2 Extension',
        'MT2 to MT3 Extension',
        'MT2 to MT4 Extension',
        'MT3 to MT1 Extension',
        'MT3 to MT2 Extension',
        'MT3 to MT3 Extension',
        'MT3 to MT4 Extension',
        'MT3 to MT5 Extension',
        'MT4 to MT1 Extension',
        'MT4 to MT2 Extension',
        'MT4 to MT3 Extension',
        'MT4 to MT4 Extension',
        'MT4 to MT5 Extension',
        'MT5 to MT1 Extension',
        'MT5 to MT2 Extension',
        'MT5 to MT3 Extension',
        'MT5 to MT4 Extension',
        'MT5 to MT5 Extension',
        'MT5 to MT6 Extension',
        'MT6 to MT2 Extension',
        'MT6 to MT3 Extension',
        'MT6 to MT4 Extension',
        'MT6 to MT5 Extension',
        'MT6 to MT6 Extension',
        'MT6 to MT7 Extension',
        'NT30-F1-M12 Adapter',
        'BT30-F1-M12 Adapter',
        'MT2-F1-M10 Adapter',
        'MT3-F1-M12 Adapter',
