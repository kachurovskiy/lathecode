...
export type AppSettings = {
  ...
  pixelRoughStairToleranceMm: number,
...
export const APP_SETTING_SECTIONS: readonly AppSettingSectionDefinition[] = [
  ...
  },
  {
    ...
    definitions: [
      ...
      {
        key: 'pixelRoughStairToleranceMm',
        type: 'number',
        label: 'Rough stair tolerance',
        storageKey: 'pixelRoughStairToleranceMm',
        defaultValue: DEFAULT_APP_SETTINGS.pixelRoughStairToleranceMm,
        min: 0,
        max: 0.1,
        step: 0.001,
        unit: 'mm',
        reasonableValues: '0.01 to 0.03',
        guidance: 'Maximum geometric deviation allowed when simplifying small roughing stair-steps into straight moves. The planner also caps this to one quarter of finish allowance.',
      },
      {
